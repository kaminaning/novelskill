...
输出前逐项检查：
- [ ] AI味检测报告包含整体评估（等级 + 主要问题） [必填]
- [ ] 问题标记表含位置/类型/原文/问题四列 [必填]
- [ ] 问题标记表标注至少 3 处具体问题位置 [必填]
- [ ] 润色报告包含修改统计（总修改数 + 6 类别计数） [必填]
- [ ] 润色报告包含修改前后对比（逐段展示） [必填]
- [ ] 润色报告包含润色后全文 [必填]
- [ ] 禁用词替换遵循「展示替代告诉」原则（非简单换形容词） [必填]
- [ ] 未改变原文剧情/人设/情节走向（只改「怎么说」） [必填]
