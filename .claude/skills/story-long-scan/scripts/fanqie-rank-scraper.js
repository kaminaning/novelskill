 ...
 *
 * 前置（macOS）：
 *   bash {SKILL_DIR}/../browser-cdp/scripts/setup_cdp_chrome.sh 9222
 * 前置（Windows）：
 *   powershell -ExecutionPolicy Bypass -File {SKILL_DIR}/../browser-cdp/scripts/setup_cdp_windows.ps1 9222
 */
